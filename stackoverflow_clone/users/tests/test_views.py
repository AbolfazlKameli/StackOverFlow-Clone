...
from stackoverflow_clone.users.models import User, UserProfile
from stackoverflow_clone.users.views import UsersListAPI
...
class TestUserRegisterVerificationAPI(APITestCase):
    ...
    @patch('stackoverflow_clone.users.views.JWT_token.get_object_or_404')
...
class TestResendVerificationEmailAPI(APITestCase):
    ...
    @patch('stackoverflow_clone.utils.send_email.send_link')
...
class TestUserProfileAPI(APITestCase):
    ...
    @patch('stackoverflow_clone.users.views.send_verification_email.delay_on_commit')
    ...
    @patch('stackoverflow_clone.users.views.Bucket.delete_object')
